...
/*outros js*/
eval(fs.readFileSync('./functions/commands/commands.js') + fs.readFileSync('./functions/voiceEvents/voiceJoin.js') +  fs.readFileSync('./functions/database/fbase.js') + fs.readFileSync('./functions/scrap/steamTopGames.js') + fs.readFileSync('./functions/guildCreate/guildCreate.js') + fs.readFileSync('./functions/scrap/topPorn.js') + fs.readFileSync('./functions/puppeteer/neonImg.js') + '');
